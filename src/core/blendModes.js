...
const ALPHA_NOISE_FLOOR = 1 / 255; // Remove low-level quantization noise from alpha map
const ALPHA_THRESHOLD = 0.001;     // Ignore very small alpha values after noise floor removal
