...
<p align="center">
  ...
  <a href="https://github.com/cf12436/gemini-watermark-remover"><img src="https://img.shields.io/badge/GitHub-源码仓库-181717?style=for-the-badge" alt="GitHub 源码仓库"></a>&nbsp;
  <a href="https://ducttape3.org/en/tools/gemini-watermark-remover"><img src="https://img.shields.io/badge/立即使用-ducttape3.org-06b6d4?style=for-the-badge" alt="立即使用在线工具"></a>
</p>
...
- **无需安装** — 直接打开 [ducttape3.org/en/tools/gemini-watermark-remover](https://ducttape3.org/en/tools/gemini-watermark-remover) 即可使用。
- **隐私友好** — 核心处理流程在浏览器本地完成，适合快速处理 Gemini 图片。
- **操作直观** — 上传图片后可预览去水印前后差异，再复制或下载结果。
- **免费访问** — 推荐收藏官方在线入口：[`https://ducttape3.org/en/tools/gemini-watermark-remover`](https://ducttape3.org/en/tools/gemini-watermark-remover)。

## 特性

- ✅ **100% 本地处理** - 所有图片处理都在你的浏览器或本地环境中完成，核心流程不会上传图片
...
1. 浏览器打开 **[ducttape3.org/en/tools/gemini-watermark-remover](https://ducttape3.org/en/tools/gemini-watermark-remover)**
2. 拖拽、粘贴或点击选择带水印的 Gemini 图片
3. 工具会检测右下角可见 Gemini 水印，并在浏览器本地恢复受影响像素
4. 通过预览滑块对比去水印前后的差异
5. 复制或下载处理后的图片

> 官方在线入口：[`https://ducttape3.org/en/tools/gemini-watermark-remover`](https://ducttape3.org/en/tools/gemini-watermark-remover)
...
2. 在仓库内执行 `pnpm build` 构建脚本
3. 从 `dist/userscript/gemini-watermark-remover.user.js` 安装脚本
4. 打开 Gemini 对话页面
...
本工具专门针对 Gemini 可见水印（右下角半透明 Logo）。如果图片水印不属于 Gemini 已知格式，算法会尽量避免误处理；建议先保留原图，并在处理后仔细对比结果。
...
- [ducttape3.org 在线 Gemini 去水印工具](https://ducttape3.org/en/tools/gemini-watermark-remover) — 推荐使用的在线版本
- [ducttape3.org](https://ducttape3.org) — 更多 AI 工具与资源
